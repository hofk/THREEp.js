...
*/
	...
	g = this;  //  THREE.BufferGeometry() - geometry objects from three.js
	...
	g.explodemode =		p.explodemode !== undefined ?		p.explodemode		: 'center'; //only non-indexed BufferGeometry
	...
	g.explode =			p.explode !== undefined ? 			p.explode			: function ( t ) { return 0 }; // only non-indexed BufferGeometry
	...
	// The sequence of the faces can be determined with vertexFaceNumbersHelper.
